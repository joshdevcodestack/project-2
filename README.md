...
#bestscore, #score{
    ...
    <body>
        <div id="container">
            ...
            <div id="rules">Rules<br><br>
                <span class="inforules">Select at least three balls of<br> the same color<br> that are touching<br>created by Joshua</span><br>
                <span  class="inforules">Big Bonus: 8 Balls minimun</span>
                <span  class="inforules">⏳: Surprise time bonus</span><br><br><br>
            ...
            <div id="endgame">Game Over <br><br>
                <span id="bestscore"></span>
                <span id="score"></span><br><br><br>
...
const colors = ['#FF2818', '#F4E204', '#030DFF','#E048FF']
